		...
		<table>
			...
			<tr>
			  <td><strong>标题：</strong></td>
				<td><input type="text" name="renmess.tiTle"></td>
			</tr>
			<tr>
			...
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="renmess.reNtal"/>元/月</td>
			</tr>
<!-- 			<tr>
			...
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="renmess.phOne"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="renmess.naMes"></td>
			</tr>
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="renmess.meSsage" rows="10" cols="40"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
