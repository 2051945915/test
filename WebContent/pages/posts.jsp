...
<script type="text/javascript" src="jquery/jquery-2.2.1.js"></script>

<script type="text/javascript">

	/* 设置房屋类型选中 */
	$(function(){
		$("#lxy").find("option[value='${RENMESS_ONE.rtId}']").attr("selected",true);
	});
	...
	<form action="../insertRenmessa" method="post" name="mf" onsubmit="return validateTitle()">
		...
		<table>
			...
			<tr>
			  <td><strong>标题：</strong></td>
				<td><input type="text" name="renmess.tiTle" value="${RENMESS_ONE.tiTle}"></td>
			</tr>
			<tr>
			  <td><strong>区县：</strong></td>
				<td>
				<select name="renmess.coUnty" id="qxid" onChange="selectjd()">
			...
			<tr>
			  <td><strong>街道：</strong></td>
				<td><select name="renmess.stReet" id="jdid">
					<option value="0">不限--</option>
				</select></td>
			</tr>
			<tr>
			  <td><strong>租金：</strong></td>
				<td><input type="text" name="renmess.reNtal" value="${RENMESS_ONE.reNtal}"/>元/月</td>
			</tr>
			<tr>
			  <td><strong>房屋类型：</strong></td>
				<td>
					<select name="renmess.rtId" id="lxy">
			...
			<tr>
			  <td><strong>联系电话：</strong></td>
				<td><input type="text" name="renmess.phOne" value="${RENMESS_ONE.phOne}"></td>
			</tr>
			<tr>
			  <td><strong>联系人：</strong></td>
				<td><input type="text" name="renmess.naMes" value="${RENMESS_ONE.naMes}"></td>
			</tr>
			<tr>
			  <td><strong>房屋信息：</strong></td>
				<td><textarea name="renmess.meSsage" rows="10" cols="40" >${RENMESS_ONE.meSsage}</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
