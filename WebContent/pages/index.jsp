...
<script language="javascript">
	...
	<form action="../usersLoga" method="post" name="myForm" onsubmit="return login()">
  	<p>&nbsp;</p>
	  <table align="center">
		<tr>
			<td colspan="2">用户名：</td>
		...
		<tr>
		  <td colspan="2"><input type="text" id="usName" name="users.usName" size=10" class="editbox"></td>
		</tr>
		<tr>
			<td colspan="2">密&nbsp;&nbsp;码：</td>
			</tr>
		<tr>
		  <td colspan="2"><input type="password" id="usPass" name="users.usPass" size="10"  class='editbox'></td>
		  </tr>
		<tr>
			<td>
...
<option value='18'>平谷</option>
			...
			<tr>
				<td>房屋类型：</td>
				<td>
<input type="checkbox">地下室
<input type="checkbox">平房
<input type="checkbox">普通住宅
...
<table width="88%" cellspacing="0">
			...
			<!-- 	<tr>
				...
				<tr>
					<td><a href='detail.htm'>健翔桥一居出租了</a></td>
					<td align='center' style='height:30px;'>300元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>北大附近招合租</a></td>
					<td align='center' style='height:30px;'>1000元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>出租鼓楼地铁附近/鼓楼西大街/绝好平房!</a></td>
					<td align='center' style='height:30px;'>1500元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>北三环北太平庄蓟门桥蓟门里小区两居</a></td>
					<td align='center' style='height:30px;'>2200元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				<tr>
					<td><a href='detail.htm'>后现代城一居室出租</a></td>
					<td align='center' style='height:30px;'>2400元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>北太平庄房屋出租</a></td>
					<td align='center' style='height:30px;'>1000元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>西便门北二区出租3室1厅</a></td>
					<td align='center' style='height:30px;'>1900元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>便宜出租前门四合院</a></td>
					<td align='center' style='height:30px;'>2500元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>出租2居</a></td>
					<td align='center' style='height:30px;'>2100元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='detail.htm'>qq的租房信息1</a></td>
					<td align='center' style='height:30px;'>1000元</td>
					<td align='center'>2007-07-02</td>
				</tr> -->
				
				<tr>
					<td colspan='3'><hr/><strong><span class="fk fk_cur"></span><span class="pc">1</span></strong><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=10&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk fkd"></span><span class="pc">2</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=20&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk"></span><span class="pc">3</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=30&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk fkd"></span><span class="pc">4</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=40&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk"></span><span class="pc">5</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=50&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk fkd"></span><span class="pc">6</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=60&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk"></span><span class="pc">7</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=70&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk fkd"></span><span class="pc">8</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=80&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk"></span><span class="pc">9</span></a><a href="/s?wd=java%E4%BD%BF%E7%94%A8&pn=90&tn=24008039_dg&ie=utf-8&usm=1"><span class="fk fkd"></span><span class="pc">10</span></a></td>
				</tr>
			</table>
	</form>
	</td>
